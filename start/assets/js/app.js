! function (e) {
   ...
   ! function (t, n) {
      ...
      (T.fn.init = function (e, t, n) {
         ...
         if (n = n || L, "string" == typeof e) {
            ...
            if (i[1]) {
               if (t = t instanceof T ? t[0] : t, T.merge(this, T.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : w, !0)), D.test(i[1]) && T.isPlainObject(t))
      ...
      T.fn.ready = function (e) {
         ...
         readyWait: 1,
         ready: function (e) {
            (!0 === e ? --T.readyWait : T.isReady) || (T.isReady = !0, !0 !== e && --T.readyWait > 0 || _.resolveWith(w, [T]))
         }
      }), T.ready.then = _.then, "complete" === w.readyState || "loading" !== w.readyState && !w.documentElement.doScroll ? n.setTimeout(T.ready) : (w.addEventListener("DOMContentLoaded", F), n.addEventListener("load", F));
      ...
      function pe(e, t) {
         for (var n, i, o = [], r = 0, s = e.length; r < s; r++)(i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = J.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && le(i) && (o[r] = ue(i))) : "none" !== n && (o[r] = "none", J.set(i, "display", n)));
      ...
      function ke(e, t, n, i, o) {
         for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
            ...
            for (s = s || u.appendChild(t.createElement("div")), a = (ge.exec(r) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
      ...
      T.event = {
         ...
         add: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, p, f, h, v, g = J.get(e);
            if (G(e))
               for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(re, o), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
                  ...
                  }), c = (t = (t || "").match(M) || [""]).length; c--;) f = v = (a = Ce.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = T.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = T.event.special[f] || {}, d = T.extend({
                  type: f,
                  origType: v,
                  data: i,
                  handler: n,
         ...
         remove: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, p, f, h, v, g = J.hasData(e) && J.get(e);
            if (g && (l = g.events)) {
         ...
         special: {
            ...
            click: {
               setup: function (e) {
                  var t = this || e;
                  return ve.test(t.type) && t.click && j(t, "input") && De(t, "click", $e), !1
               },
               trigger: function (e) {
                  var t = this || e;
      ...
      function ze(e, t, n, i) {
         ...
         if (p && (r = (o = ke(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            for (a = (s = T.map(we(o, "script"), Pe)).length; u < p; u++) c = o, u !== f && (c = T.clone(c, !0, !0), a && T.merge(s, we(c, "script"))), n.call(e[u], c, u);
            if (a)
               for (d = s[s.length - 1].ownerDocument, T.map(s, qe), u = 0; u < a; u++) c = s[u], ye.test(c.type || "") && !J.access(c, "globalEval") && T.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? T._evalUrl && !c.noModule && T._evalUrl(c.src, {
                  nonce: c.nonce || c.getAttribute("nonce")
               }, d) : x(c.textContent.replace(Ne, ""), c, d))
         }
         return e
      }
      ...
      function Ue(e, t, n) {
         ...
         return (n = n || _e(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || se(e) || (s = T.style(e, t)), !g.pixelBoxStyles() && Re.test(s) && Be.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
      }
      ...
      function Xe(e, t) {
         ...
         d.style && (d.style.backgroundClip = "content-box", d.cloneNode(!0).style.backgroundClip = "", g.clearCloneStyle = "content-box" === d.style.backgroundClip, T.extend(g, {
            ...
            reliableTrDimensions: function () {
               var e, t, i, o;
               return null == a && (e = w.createElement("table"), t = w.createElement("tr"), i = w.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", t.style.height = "1px", i.style.height = "9px", re.appendChild(e).appendChild(t).appendChild(i), o = n.getComputedStyle(t), a = parseInt(o.height) > 3, re.removeChild(e)), a
            }
         }))
      }();
      ...
      T.extend({
         ...
         style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
               var o, r, s, a = V(t),
                  l = Ke.test(t),
                  c = e.style;
               if (l || (t = Qe(a)), s = T.cssHooks[t] || T.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
         ...
         css: function (e, t, n, i) {
            var o, r, s, a = V(t);
            return Ke.test(t) || (t = Qe(a)), (s = T.cssHooks[t] || T.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Ue(e, t, i)), "normal" === o && t in et && (o = et[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
         }
         ...
         css: function (e, t) {
            return B(this, (function (e, t, n) {
               var i, o, r = {},
                  s = 0;
               if (Array.isArray(t)) {
                  for (i = _e(e), o = t.length; s < o; s++) r[t[s]] = T.css(e, t[s], !1, i);
                  return r
               }
      ...
      function ct() {
         st && (!1 === w.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(ct) : n.setTimeout(ct, T.fx.interval), T.fx.tick())
      }
      ...
      function ft(e, t, n) {
         ...
         for (! function (e, t) {
            ...
            if (i = ft.prefilters[r].call(c, e, d, c.opts)) return y(i.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
         return T.map(d, pt, c), y(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), T.fx.timer(T.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
         })), c
      ...
      T.Animation = T.extend(ft, {
            ...
            prefilters: [function (e, t, n) {
               ...
               for (i in n.queue || (null == (s = T._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                  ...
                  for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = J.get(e, "display")), "none" === (d = T.css(e, "display")) && (c ? d = c : (pe([e], !0), c = e.style.display || c, d = T.css(e, "display"), pe([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === T.css(e, "float") && (l || (p.done((function () {
                        h.display = c
      ...
      T.extend(T.event, {
         trigger: function (e, t, i, o) {
            ...
            if (s = p = a = i = i || w, 3 !== i.nodeType && 8 !== i.nodeType && !kt.test(v + T.event.triggered) && (v.indexOf(".") > -1 && (g = v.split("."), v = g.shift(), g.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[T.expando] ? e : new T.Event(v, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : T.makeArray(t, [e]), u = T.event.special[v] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, t))) {
               ...
               for (r = 0;
                  (s = h[r++]) && !e.isPropagationStopped();) p = s, e.type = r > 1 ? l : u.bindType || v, (d = (J.get(s, "events") || Object.create(null))[e.type] && J.get(s, "handle")) && d.apply(s, t), (d = c && s[c]) && d.apply && G(s) && (e.result = d.apply(s, t), !1 === e.result && e.preventDefault());
               return e.type = v, o || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !G(i) || c && y(i[v]) && !m(i) && ((a = i[c]) && (i[c] = null), T.event.triggered = v, e.isPropagationStopped() && p.addEventListener(v, Tt), i[v](), e.isPropagationStopped() && p.removeEventListener(v, Tt), T.event.triggered = void 0, a && (i[c] = a)), e.result
            }
         },
      ...
      Rt.href = St.href, T.extend({
         ...
         ajax: function (e, t) {
            ...
            if (g.promise(S), f.url = ((e || f.url || St.href) + "").replace(Mt, St.protocol + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(M) || [""], null == f.crossDomain) {
               l = w.createElement("a");
               try {
            ...
            for (u in (d = T.event && f.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !qt.test(f.type), o = f.url.replace(Nt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Lt, "+")) : (p = f.url.slice(o.length), f.data && (f.processData || "string" == typeof f.data) && (o += ($t.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Ht, "$1"), p = ($t.test(o) ? "&" : "?") + "_=" + Ct.guid++ + p), f.url = o + p), f.ifModified && (T.lastModified[o] && S.setRequestHeader("If-Modified-Since", T.lastModified[o]), T.etag[o] && S.setRequestHeader("If-None-Match", T.etag[o])), (f.data && f.hasContent && !1 !== f.contentType || t.contentType) && S.setRequestHeader("Content-Type", f.contentType), S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : f.accepts["*"]), f.headers) S.setRequestHeader(u, f.headers[u]);
            if (f.beforeSend && (!1 === f.beforeSend.call(h, S, f) || c)) return S.abort();
            if (k = "abort", y.add(f.complete), S.done(f.success), S.fail(f.error), i = Ft(zt, f, t, S)) {
            ...
            function C(e, t, s, l) {
               ...
               }(f, S, s)), !u && T.inArray("script", f.dataTypes) > -1 && (f.converters["text script"] = function () {}), b = function (e, t, n, i) {
                  var o, r, s, a, l, c = {},
                     d = e.dataTypes.slice();
                  if (d[1])
      ...
      T.ajaxSetup({
         ...
         if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Gt, "$1" + o) : !1 !== e.jsonp && (e.url += ($t.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
      ...
      })), g.createHTMLDocument = ((Yt = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Yt.childNodes.length), T.parseHTML = function (e, t, n) {
         return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (g.createHTMLDocument ? ((i = (t = w.implementation.createHTMLDocument("")).createElement("base")).href = w.location.href, t.head.appendChild(i)) : t = w), r = !n && [], (o = D.exec(e)) ? [t.createElement(o[1])] : (o = ke([e], t, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
         var i, o, r
         ...
         setOffset: function (e, t, n) {
            var i, o, r, s, a, l, c = T.css(e, "position"),
               d = T(e),
               u = {};
            "static" === c && (e.style.position = "relative"), a = d.offset(), r = T.css(e, "top"), l = T.css(e, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (s = (i = d.position()).top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), y(t) && (t = t.call(e, n, T.extend({}, a))), null != t.top && (u.top = t.top - a.top + s), null != t.left && (u.left = t.left - a.left + o), "using" in t ? t.using.call(e, u) : ("number" == typeof u.top && (u.top += "px"), "number" == typeof u.left && (u.left += "px"), d.css(u))
         }
      }, T.fn.extend({
         offset: function (e) {
   ...
   o()(window).on("load", (function () {
      ...
      o()("._span-cheap").hide(0), o()(".bunner__cheap").mouseover((function (e) {
         o()(this).find(" ._span-cheap ").show(200)
      })).mouseleave((function (e) {
         o()(this).find(" ._span-cheap ").hide(200)
      }))
   })), o()(document).ready((function (e) {
      o()(".menu-tab ").slideUp(0), o()(".menu__item--tab ").hover((function (e) {
         var t = o()(this).find(" .menu-tab ");
         o()(this).hasClass("act") ? (t.slideUp(200), o()(this).removeClass("act"), o()(this).find("svg").css("transform", "translateY(-50%) rotate(90deg)")) : (t.slideDown(200), o()(this).addClass("act"), o()(this).find("svg").css("transform", "translateY(-50%) rotate(-90deg)"))
      }))
   })), o()(document).ready((function (e) {
      o()(".header__burger").on("click", (function () {
         o()(".menu").addClass("menu-active").append(o()("<div class='header__info info'><a class='btn btn--success info__button _f-button' href='#!'>Kontaktai</a></div>")), setTimeout((function () {
            o()(".info").addClass("info-active")
         }), 200), o()("body").addClass("lock")
      })), o()(".header__close").on("click", (function () {
         o()(".menu").removeClass("menu-active").find(".header__info").remove(), o()(".info").removeClass("info-active"), o()("body").removeClass("lock")
      }))
   })), window.addEventListener("scroll", (function (e) {
      window.pageYOffset > 100 ? document.querySelector(".header").classList.add("responciveHeader") : document.querySelector(".header").classList.remove("responciveHeader")
   })), window.onresize = function () {
      window.innerWidth >= 999 && (o()(".menu").removeClass("menu-active").find(".header__info").remove(), o()(".info").removeClass("info-active"), o()("body").removeClass("lock"))
   }, o()(".select").each((function () {
      var e = o()(this),
         t = e.find("option"),
         n = t.length;
      t.filter(":selected");
      e.hide(), e.wrap('<div class="select"></div>'), o()("<div>", {
         class: "new-select",
      ...
      for (var r = i.next(".new-select__list"), s = 1; s < n; s++) o()("<div>", {
         class: "new-select__item",
         html: o()("<span>", {
            text: t.eq(s).text()
         })
      }).attr("data-value", t.eq(s).val()).appendTo(r);
      var a = r.find(".new-select__item");
      r.slideUp(0), i.on("click", (function () {
         o()(this).hasClass("on") ? (o()(this).removeClass("on"), r.slideUp(200)) : (o()(this).addClass("on"), r.slideDown(200), a.on("click", (function () {
            var e = o()(this).data("value");
            o()("select").val(e).attr("selected", "selected"), i.text(o()(this).find("span").text()), r.slideUp(200), i.removeClass("on")
         })))
      }))
      ...
      var t = o()(".select");
      t.is(e.target) || 0 !== t.has(e.target).length || (o()(".new-select").removeClass("on"), o()(".new-select__list").slideUp(300))
   })), o()(document).ready((function () {
      var e = o()(".popup"),
         t = o()(".popup-init-js"),
         n = o()(".popup__close");
      e.fadeOut(0), t.on("click", (function () {
         e.fadeIn(200), o()("body").css("overflow", "hidden")
      })), n.on("click", (function () {
         e.fadeOut(200), o()("body").css("overflow", "visible")
      }))
   })), o()(document).on("mouseup", (function (e) {
      o()(".popup__overlay").is(e.target) && (o()(".popup").fadeOut(200), o()("body").css("overflow", "visible"))
   })), o()(document).ready((function (e) {
      ! function () {
         var e = ["-webkit-slider-runnable-track"];
         ! function () {
            for (var e = document.querySelectorAll("input[type=range]"), n = window.getComputedStyle(e[0], "::-webkit-slider-thumb").background, i = 0; i < e.length; i += 1) {
               n || (e[i].style.WebkitAppearance = "slider-horizontal");
               var o = document.createElement("style");
               o.id = "s" + e[i].id, document.head.appendChild(o), e[i].addEventListener("input", (function () {
                  t(this)
               }), !1), e[i].addEventListener("change", (function () {
                  t(this)
               }), !1), e[i].output = e[i].parentNode.querySelector("output");
               var r = e[i].parentNode.querySelector("span");
               if (r && r.getAttribute("data-labels")) {
                  e[i].values = [];
                  for (var s = r.getAttribute("data-labels").split(";"), a = 0; a < s.length; a += 1) e[i].values.push(s[a])
               }
               1 * e[i].value && t(e[i])
            }
         }();
         ...
         function t(t) {
            var n = Math.round(t.value / t.getAttribute("max") * 1 * 100),
               i = "linear-gradient(90deg,#7AB764 " + n + "%,#E5E5E5 " + (n + 1) + "%)",
               o = "input[id=" + t.id + "]::",
               r = "",
               s = t.values ? t.values[t.value] : t.value;
            t.output.innerHTML = s;
            for (var a = 0; a < e.length; a += 1) r += o + e[a] + "{background: " + i + ";} ";
            document.getElementById("s" + t.id).textContent = r
         }
      }()
   }));
   n(2);
   o()(Document).ready((function () {
      o()(".slider-js-posts-side").slick({
         slidesToShow: 5,
         speed: 1500,
         easing: "ease",
         centerMode: !1,
      ...
      }), o()(".slider-js-posts-projects").slick({
         slidesToShow: 3,
         speed: 1500,
         easing: "ease",
         centerMode: !1,
         ...
         customPaging: function (e, t) {
            ...
            n = n < 10 ? "" + n : n;
            var i = e.slideCount;
            return '<button type="button" role="button" tabindex="0" class="slick-dots-button">        \t\t<span class="slick-dots-current">' + n + '</span>        \t\t<span class="slick-dots-separator">/</span>        \t\t<span class="slick-dots-total">' + (i = i < 10 ? "" + i : i) + "</span></button>"
         }
      }), o()(".slider-js-1").slick({
         arrows: !1,
         slidesToShow: 1,
